...
## CodeSystem: Grupo de Atendimento 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/CodeSystem/BRGrupoAtendimento | *Version*:0.1.0 | |
...
Este case-sensitive sistema de código `http://www.saude.gov.br/fhir/r4/CodeSystem/BRGrupoAtendimento` define o seguinte códigos:
