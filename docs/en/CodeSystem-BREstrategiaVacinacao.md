# Estratégia de Vacinação (CodeSystem) - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v1.0.0-release
...
```json
{
  ...
  "title" : "Estratégia de Vacinação (CodeSystem)",
  "status" : "active",
  "experimental" : false,
