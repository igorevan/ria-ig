# Registro de Imunobiológico Administrado na Rotina - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v1.0.0-release
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/br.gov.saude.ria.fhir|current/StructureDefinition/StructureDefinition-BRRegistroImunobiologicoAdministradoRotina-2.0.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["http://www.saude.gov.br/fhir/r4/StructureDefinition/BRImunobiologicoAdministrado-3.0"]
      }],
      "mustSupport" : true
    },
    {
