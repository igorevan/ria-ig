# Registro de Imunobiológico Administrado na Rotina - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0

* [**Índice**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Registro de Imunobiológico Administrado na Rotina**

## Resource Profile: Registro de Imunobiológico Administrado na Rotina 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/StructureDefinition/BRRegistroImunobiologicoAdministradoRotina-2.0 | *Version*:0.1.0 | |
| *Standards status:*[Informative](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:BRRegistroImunobiologicoAdministradoRotina |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/br.gov.saude.ria.fhir|current/StructureDefinition/BRRegistroImunobiologicoAdministradoRotina-2.0)
...
Other representations of profile: [CSV](StructureDefinition-BRRegistroImunobiologicoAdministradoRotina-2.0.csv), [Excel](StructureDefinition-BRRegistroImunobiologicoAdministradoRotina-2.0.xlsx), [Schematron](StructureDefinition-BRRegistroImunobiologicoAdministradoRotina-2.0.sch) 
