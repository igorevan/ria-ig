# Via de Administração - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/CodeSystem/BRViaAdministracao | *Version*:0.1.0 | |
...
Este case-sensitive sistema de código `http://www.saude.gov.br/fhir/r4/CodeSystem/BRViaAdministracao` define o seguinte códigos:
