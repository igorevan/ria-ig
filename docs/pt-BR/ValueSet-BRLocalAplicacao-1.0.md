# Local de Aplicação (ValueSet) - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v1.0.0-release
...
```json
{
  ...
  "title" : "Local de Aplicação (ValueSet)",
  "status" : "active",
  "experimental" : false,
