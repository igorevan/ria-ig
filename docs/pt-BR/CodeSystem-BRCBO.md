# Classificação Brasileira de Ocupações - CBO (CodeSystem) - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v1.0.0-release

## CodeSystem: Classificação Brasileira de Ocupações - CBO (CodeSystem) 
...
```json
{
  ...
  "name" : "BRCBO",
  "title" : "Classificação Brasileira de Ocupações - CBO (CodeSystem)",
  "status" : "active",
  "experimental" : false,
