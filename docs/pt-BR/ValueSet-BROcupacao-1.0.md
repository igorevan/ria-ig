# Classificação Brasileira de Ocupações - CBO (ValueSet) - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v1.0.0-release
...
```json
{
  ...
  "name" : "BROcupacao",
  "title" : "Classificação Brasileira de Ocupações - CBO (ValueSet)",
  "status" : "active",
  "experimental" : false,
