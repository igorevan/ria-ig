# Classificação Brasileira de Ocupações (CBO) - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BROcupacao-1.0 | *Version*:0.1.0 | |
...
Expansão a partir de tx.fhir.org com base em [codesystem Classificação Brasileira de Ocupações (CBO) v0.1.0 (CodeSystem)](CodeSystem-BRCBO.md)
