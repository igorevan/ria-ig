...
## ValueSet: Estratégia de Vacinação 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BREstrategiaVacinacao-1.0 | *Version*:0.1.0 | |
...
* Include todos os códigos definidos em `http://www.saude.gov.br/fhir/r4/CodeSystem/BREstrategiaVacinacao`versão 📍
