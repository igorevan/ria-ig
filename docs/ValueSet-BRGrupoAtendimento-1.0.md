# Tipo de grupo de atendimento - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0

* [**Índice**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tipo de grupo de atendimento**

## ValueSet: Tipo de grupo de atendimento 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BRGrupoAtendimento-1.0 | *Version*:0.1.0 | |
...
* Include todos os códigos definidos em `http://www.saude.gov.br/fhir/r4/CodeSystem/BRGrupoAtendimento`versão 📍

 

### Expansion

Expansão a partir de tx.fhir.org com base em [codesystem Grupo de Atendimento v0.1.0 (CodeSystem)](CodeSystem-BRGrupoAtendimento.md)

Este conjunto de valores contém 107 conceitos
