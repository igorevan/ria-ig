# Bundle de exemplo do RIA-R - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0

* [**Índice**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bundle de exemplo do RIA-R**
...
Perfil: [Imunobiológico Administrado em Rotina](StructureDefinition-BRImunobiologicoAdministrado-3.0.md)

**Grupo de Atendimento**:Povos indígenas vivendo em terras indígenas**Condição Maternal**:Não se aplica**Contato Hanseníase**: false**status**: Completed**vaccineCode**:HAinf**manufacturer**: Nenhum ecrã para Immunization.manufacturer (reference: id: http://www.saude.gov.br/fhir/r4/CodeSystem/BRFabricantePNI#152)**lotNumber**: 220262**expirationDate**: 2025-05-10**patient**: Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BRIndividuo-1.0`/01234567890**occurrence**: 2024-04-01**primarySource**: false**location**: Identifier:`http://www.saude.gov.br/fhir/r4/CodeSystem/BRPais`/10**site**:Sem registro no sistema de informação de origem**route**:Sem registro no sistema de informação de origem
...
| :--- | :--- | :--- |
| - | **Function** | **Actor** |
| * | MEDICO INFECTOLOGISTA | [Practitioner/012345678912345](Practitioner/012345678912345) |

> **protocolApplied****Estratégia de Vacinação**:Rotina
> **Estratégia de Vacinação Pesquisa**
* numeroProtocoloEstudoANVISA: GU1AMT9CYR
* numeroVersaoProtocoloEstudo: F3D1U354V6
* numeroRegistroVacinaAnvisa: WWZZJJWIBF
...
Última atualização: 2024-03-30 14:59:51-0300

Perfil: [CID10 Avaliado](StructureDefinition-BRCID10Avaliado-1.0.md)

**clinicalStatus**:Active**category**:Principal**code**:Hepatite aguda A**subject**: Identifier:`http://www.saude.gov.br/fhir/r4/StructureDefinition/BRIndividuo-1.0`/01234567890**onset**: 2024-03-30 14:59:51-0300
