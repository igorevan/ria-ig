# Estratégia de Vacinação Pesquisa - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/StructureDefinition/BREstrategiaVacinacaoPesquisa-1.0 | *Version*:0.1.0 | |
| *Standards status:*[Informative](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:BREstrategiaVacinacaoPesquisa |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/br.gov.saude.ria.fhir|current/StructureDefinition/BREstrategiaVacinacaoPesquisa-1.0)
...
Other representations of profile: [CSV](StructureDefinition-BREstrategiaVacinacaoPesquisa-1.0.csv), [Excel](StructureDefinition-BREstrategiaVacinacaoPesquisa-1.0.xlsx), [Schematron](StructureDefinition-BREstrategiaVacinacaoPesquisa-1.0.sch) 
