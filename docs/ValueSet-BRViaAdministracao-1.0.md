# Via de Administração do Imunobiológico - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BRViaAdministracao-1.0 | *Version*:0.1.0 | |
| *Standards status:*[Informative](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:BRViaAdministracao |
...
* Include todos os códigos definidos em `http://www.saude.gov.br/fhir/r4/CodeSystem/BRViaAdministracao`versão 📍
