...
## ValueSet: Local de Aplicação 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://www.saude.gov.br/fhir/r4/ValueSet/BRLocalAplicacao-1.0 | *Version*:0.1.0 | |
...
* Include todos os códigos definidos em `http://www.saude.gov.br/fhir/r4/CodeSystem/BRLocalAplicacao`versão 📍

 

### Expansion

Expansão a partir de tx.fhir.org com base em [codesystem Local de Aplicação v0.1.0 (CodeSystem)](CodeSystem-BRLocalAplicacao.md)

Este conjunto de valores contém 24 conceitos
