# CID10 Avaliado - Guia de Implementação do Registro de Imunobiológico Administrado (RIA) da RNDS v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/br.gov.saude.ria.fhir|current/StructureDefinition/BRCID10Avaliado-1.0)
